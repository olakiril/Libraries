function [tcp,functionName,params] = getFunctionCall(tcp,blocking)
...
if nargin > 1 && strcmp(blocking,'noblock') && ...
        isempty(pnet(tcp.con,'read',1,'char',[],'view','noblock'))
    functionName = [];
    params = [];
    return
end
...
% disp(sprintf('Function: %s and inFunctionCall: %u\n',functionName,tcp.inFunctionCall))