function autoArrangeFigures(NH, NW,varargin)
% INPUT  :
...
screen_sz = screen_sz(params.monitor_id, :);

scn_w = screen_sz(3) - params.offset(1);
scn_h = screen_sz(4) - params.offset(2);
scn_w_begin = screen_sz(1) + params.offset(1);
scn_h_begin = screen_sz(2) + params.offset(2);
